...
//Facing (Direction you're facing after transition)

if (facing = 0) {
	
		obj_player.sprite_index = spr_krisrightlw
}

if (facing = 1) {
	
		obj_player.sprite_index = spr_krisleftlw
}

if (facing = 2) {
	
		obj_player.sprite_index = spr_krisdownlw
}

if (facing = 3) {
	
		obj_player.sprite_index = spr_krisuplw
}
