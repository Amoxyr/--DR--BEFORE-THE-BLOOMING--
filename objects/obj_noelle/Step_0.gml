...
if inparty = true {
	...
	sprite_index = spr_noelledownlw 
	
	
} else if inparty = true {
	sprite_index = spr_noelleleftlw
	
	
} else if inparty = true {
	sprite_index = spr_noellerightlw
	
} else if inparty = true {
	sprite_index = spr_noelleuplw
...
if global.party_member_1 = obj_noelle{
	...
	case spr_krisdownlw: sprite_index = spr_noelledownlw; break;
	case spr_krisleftlw: sprite_index = spr_noelleleftlw; break;
	case spr_krisrightlw: sprite_index = spr_noellerightlw; break;
	case spr_krisuplw: sprite_index = spr_noelleuplw; break;
