...
if menu = 3{
	...
	draw_text(x, y + 22, "Cancel - " + obj_title.cancelkey)
	...
	draw_text(x + 115,  y + 22, "Right - Right Arrow/" + obj_title.rightkey)
	...
	draw_text(x + 172,  y, "Fullscreen/" + obj_title.fullscreenkey)
